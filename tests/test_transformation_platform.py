...
class TestEditModels:
    def test_text_edit_immutable(self) -> None:
        edit = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
    ...
    def test_composite_edit_immutable(self) -> None:
        t_edit = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
    ...
    def test_edit_invalid_metadata_type(self) -> None:
        with pytest.raises(TypeError):
            TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a", metadata="data")  # type: ignore[arg-type]

    def test_edit_equality(self) -> None:
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
        e2 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
        assert e1 == e2

    def test_edit_inequality(self) -> None:
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
        e2 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="b")
        assert e1 != e2

    def test_text_edit_ordering(self) -> None:
        e1 = TextEdit(file=Path("test.py"), start_line=2, start_col=1, end_line=2, end_col=2, new_text="a")
        e2 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="b")
        assert e2 < e1
    ...
    def test_edit_metadata_mapping(self) -> None:
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a", metadata={"key": "val"})
...
class TestEditEngine:
    def test_apply_single_edit(self, engine: EditEngine) -> None:
        content = "def foo():\n    pass\n"
        edit = TextEdit(file=Path("test.py"), start_line=1, start_col=4, end_line=1, end_col=7, new_text="bar")
    ...
    def test_apply_multiple_edits(self, engine: EditEngine) -> None:
        content = "def foo():\n    pass\n\nfoo()\n"
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=4, end_line=1, end_col=7, new_text="bar")
        e2 = TextEdit(file=Path("test.py"), start_line=4, start_col=0, end_line=4, end_col=3, new_text="bar")
    ...
    def test_apply_multi_line_edit(self, engine: EditEngine) -> None:
        content = "def foo():\n    pass\n"
        edit = TextEdit(file=Path("test.py"), start_line=2, start_col=4, end_line=2, end_col=8, new_text="return 42")
        new_content = engine.apply(content, [edit])
    ...
    def test_apply_insertion_edit(self, engine: EditEngine) -> None:
        ...
        edit = TextEdit(file=Path("test.py"), start_line=2, start_col=0, end_line=2, end_col=0, new_text="    # Comment\n")
        new_content = engine.apply(content, [edit])
    ...
    def test_apply_deletion_edit(self, engine: EditEngine) -> None:
        ...
        edit = TextEdit(file=Path("test.py"), start_line=2, start_col=0, end_line=2, end_col=9, new_text="")
        new_content = engine.apply(content, [edit])
    ...
    def test_apply_edits_reverse_order_safety(self, engine: EditEngine) -> None:
        content = "abc"
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=0, end_line=1, end_col=1, new_text="X")
        e2 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="Y")
        new_content = engine.apply(content, [e1, e2])
        assert new_content == "XYc"

    def test_apply_full_file_replacement(self, engine: EditEngine) -> None:
        content = "old content"
        edit = TextEdit(file=Path("test.py"), start_line=1, start_col=0, end_line=1, end_col=11, new_text="new content")
        new_content = engine.apply(content, [edit])
        assert new_content == "new content"

    def test_apply_preserves_unmodified_lines(self, engine: EditEngine) -> None:
        content = "line1\nline2\nline3\n"
        edit = TextEdit(file=Path("test.py"), start_line=2, start_col=0, end_line=2, end_col=5, new_text="LINE2")
        new_content = engine.apply(content, [edit])
    ...
    def test_apply_multi_file_isolation(self, engine: EditEngine) -> None:
        ...
        content = "test"
        edit = TextEdit(file=Path("other.py"), start_line=1, start_col=0, end_line=1, end_col=4, new_text="other")
        new_content = engine.apply(content, [edit])
        assert new_content == "other"

    def test_apply_unicode_content(self, engine: EditEngine) -> None:
        content = "def café():\n    pass\n"
        edit = TextEdit(file=Path("test.py"), start_line=1, start_col=4, end_line=1, end_col=8, new_text="tea")
        new_content = engine.apply(content, [edit])
...
class TestConflictDetection:
    def test_no_conflict_different_files(self, detector: ConflictDetector) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="a")
        e2 = TextEdit(file=Path("b.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="b")
        assert detector.check([e1, e2]) == []

    def test_no_conflict_same_file_different_lines(self, detector: ConflictDetector) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
        e2 = TextEdit(file=Path("a.py"), start_line=2, start_col=1, end_line=2, end_col=2, new_text="b")
        assert detector.check([e1, e2]) == []

    def test_overlap_conflict_exact_same_range(self, detector: ConflictDetector) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="a")
        e2 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="b")
    ...
    def test_overlap_conflict_partial(self, detector: ConflictDetector) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="a")
        e2 = TextEdit(file=Path("a.py"), start_line=1, start_col=3, end_line=1, end_col=4, new_text="b")
        conflicts = detector.check([e1, e2])
        assert len(conflicts) == 1
        assert "Overlap" in conflicts[0]
    ...
    def test_composite_conflict_detected(self, detector: ConflictDetector) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="a")
        e2 = TextEdit(file=Path("a.py"), start_line=1, start_col=2, end_line=1, end_col=3, new_text="b")
    ...
    def test_boundary_adjacent_no_conflict(self, detector: ConflictDetector) -> None:
        ...
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=5, new_text="a")
        e2 = TextEdit(file=Path("a.py"), start_line=1, start_col=5, end_line=1, end_col=6, new_text="b")
        assert detector.check([e1, e2]) == []
...
class TestBatchOperations:
    ...
    def test_multiple_transformations_success(self, runtime: Any) -> None:
        ...
        batch = TransformationBatch([
            RenameTransformation("foo", "func1"),
            RenameTransformation("bar", "func2")
        ])
        results = batch.execute(ctx)
    ...
    def test_stops_on_failure(self, runtime: Any) -> None:
        ...
        batch = TransformationBatch([
            ...
            RenameTransformation("nonexistent", "error")
        ])
        results = batch.execute(ctx)
        assert len(results) == 2
        assert results[0].success is True
    ...
    def test_unsupported_skipped(self, runtime: Any) -> None:
        ...
        class UnsupportedTransform:
            @property
            def name(self) -> str: return "unsupported"
            def supports(self, ctx) -> bool: return False
            def preview(self, ctx) -> Any: pass
            def validate(self, ctx) -> tuple: return ()
            def apply(self, ctx) -> TransformationResult: pass
            def undo(self, ctx, res) -> TransformationResult: pass
    ...
    def test_partial_failure_context_preserved(self, runtime: Any) -> None:
        ...
        batch = TransformationBatch([
            RenameTransformation("foo", "bar"),
            RenameTransformation("bar", "baz")  # Will fail because 'bar' wasn't committed to ctx
        ])
        results = batch.execute(ctx)
        assert results[1].success is False
    ...
    def test_batch_results_length_matches_executed(self, runtime: Any) -> None:
        ...
        batch = TransformationBatch([
            RenameTransformation("foo", "bar"),
            RenameTransformation("missing", "err")
        ])
        results = batch.execute(ctx)
        assert len(results) == 2
...
class TestPreviewDiff:
    def test_diff_single_file(self, diff_engine: DiffEngine) -> None:
        edits = [TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=4, new_text="bar")]
    ...
    def test_diff_multiple_files(self, diff_engine: DiffEngine) -> None:
        e1 = TextEdit(file=Path("a.py"), start_line=1, start_col=1, end_line=1, end_col=4, new_text="bar")
        e2 = TextEdit(file=Path("b.py"), start_line=1, start_col=1, end_line=1, end_col=4, new_text="baz")
    ...
    def test_diff_ordering(self, diff_engine: DiffEngine) -> None:
        e1 = TextEdit(file=Path("test.py"), start_line=2, start_col=1, end_line=2, end_col=4, new_text="bar")
        e2 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=4, new_text="foo")
    ...
    def test_diff_summary_stats(self, diff_engine: DiffEngine) -> None:
        edits = [
            TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=4, new_text="bar"),
            TextEdit(file=Path("test.py"), start_line=2, start_col=1, end_line=2, end_col=4, new_text="baz")
        ]
        diff = diff_engine.create_diff("test.py", edits)
...
class TestEditTransactions:
    ...
    def test_add_multiple_edits(self, transaction: EditTransaction) -> None:
        transaction.begin()
        e1 = TextEdit(file=Path("test.py"), start_line=1, start_col=1, end_line=1, end_col=2, new_text="a")
        e2 = TextEdit(file=Path("test.py"), start_line=2, start_col=1, end_line=2, end_col=2, new_text="b")
