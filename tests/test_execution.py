...
# -----------------------------------------------------------------
# Executor tests – use permissive_python_policy to allow "python"
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Event publication tests – also use permissive policy
# -----------------------------------------------------------------
...
def test_policy_rejection_publishes_rejected(
    ...
    executor = CommandExecutor(
        workspace=workspace,
        event_bus=event_bus,
        # Note: we DO NOT use permissive policy here – we want rejection
    )
