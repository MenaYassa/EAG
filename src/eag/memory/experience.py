...
class ExperienceBuilder:
    ...
    def build_from_reflection(
        ...
        if "fastapi" in raw_goal.lower(): project_type = "fastapi"
        elif "flask" in raw_goal.lower(): project_type = "flask"
        elif "calculator" in raw_goal.lower(): project_type = "calculator"
        ...
        for finding in report.findings:
            ...
            lessons.append(LessonLearned(
                ...
                recommendation=next((r.action for r in report.recommendations if getattr(r.priority, 'value', r.priority) == "high"), "")
            ))
